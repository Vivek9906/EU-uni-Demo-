...
export const metadata: Metadata = { title: 'Terms of Use', description: 'AMU Terms of Use governing access to the website and services.' };
    ...
    <section className="section-padding">
      <div className="container-main max-w-3xl">
        ...
        <div className="prose prose-lg text-foreground-secondary space-y-6 text-sm leading-relaxed">
          ...
          <p>By accessing and using the American Management University (&quot;AMU&quot;) website, you agree to be bound by these Terms of Use. If you do not agree, please discontinue use of this website.</p>
          ...
          <p>By submitting an application to AMU, you certify that all information provided is accurate and complete. AMU reserves the right to revoke any offer of admission or issued certificate if information is found to be fraudulent or materially inaccurate.</p>

          <h2 className="font-heading text-xl font-bold text-foreground mt-8">4. Intellectual Property</h2>
          <p>All content on this website — including text, graphics, logos, and design — is the property of AMU and is protected by international copyright and trademark laws. Unauthorized reproduction is prohibited.</p>

          <h2 className="font-heading text-xl font-bold text-foreground mt-8">5. Certificate Verification</h2>
          <p>AMU provides an online certificate verification service. The program name displayed on the certificate is exactly as submitted during the application process. AMU is not responsible for errors caused by applicant input.</p>

          <h2 className="font-heading text-xl font-bold text-foreground mt-8">6. Limitation of Liability</h2>
          <p>AMU provides this website on an &quot;as is&quot; basis. We do not warrant that the website will be error-free or uninterrupted. AMU shall not be liable for any indirect, incidental, or consequential damages arising from use of the website.</p>
