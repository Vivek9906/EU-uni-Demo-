      ...
      <section className="section-padding">
        <div className="container-main max-w-4xl">
          ...
          <div className="card p-8">
            ...
            <p className="text-foreground-secondary mb-6">For specific questions about fees and payment options, please contact our finance office at <a href="mailto:finance@amu.edu.eu" className="text-primary font-medium">finance@amu.edu.eu</a>.</p>
