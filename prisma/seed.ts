...
<p>"Our honorary doctorate program recognizes individuals who have demonstrated exceptional leadership and made meaningful contributions to their communities and professions," explained the Dean of Academic Affairs. "These recipients exemplify the values of excellence, integrity, and service that EU American University stands for."</p>`,
  ...
  const eventsData = [
    ...
    // Upcoming Events
    {
      title: 'Commencement & Honorary Doctorate Ceremony 2028',
      slug: 'commencement-honorary-doctorate-2028',
      ...
      date: new Date('2028-06-12T10:00:00'),
      endDate: new Date('2028-06-12T15:00:00'),
    ...
    {
      title: 'Global Business Leadership Summit 2028',
      slug: 'global-business-leadership-summit-2028',
      ...
      date: new Date('2028-03-08T09:00:00'),
      endDate: new Date('2028-03-09T17:00:00'),
    ...
    {
      title: 'MBA & Professional Development Expo 2028',
      slug: 'mba-professional-development-expo-2028',
      ...
      date: new Date('2028-01-25T10:00:00'),
      endDate: new Date('2028-01-25T18:00:00'),
    ...
    {
      title: 'Alumni Reunion & Awards Night 2027',
      slug: 'alumni-reunion-awards-night-2027',
      ...
      date: new Date('2027-12-06T18:00:00'),
      endDate: new Date('2027-12-06T23:00:00'),
      venue: 'Paris, France',
      category: 'Networking',
      imageUrl: 'https://images.unsplash.com/photo-1511578314322-379afb476865?w=800&q=80',
      isPublished: true,
    ...
    {
      title: 'Research & Innovation Conference 2027',
      slug: 'research-innovation-conference-2027',
      ...
      date: new Date('2027-10-10T09:00:00'),
      endDate: new Date('2027-10-10T17:00:00'),
      venue: 'Brussels',
      category: 'Academic',
      imageUrl: 'https://images.unsplash.com/photo-1587825140708-dfaf18c4e236?w=800&q=80',
      isPublished: true,
